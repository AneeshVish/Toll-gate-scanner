...
try{
       verify.setModel(new DefaultTableModel(null,new String[]{"username","start","end","toll_names","date","time","vehicle_type", "vehicle_number","amount","verification"}));
...
String sql="select * from history where username='"+user+"'and toll_name='"+tollname.getText()+"' and verification='Paid/not verified'";
...
adminhistorycheck.adminid.setText(adminid.getText());
