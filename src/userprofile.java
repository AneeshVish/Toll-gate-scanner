...
/**
    ...
    private void initComponents() {
        ...
        name.setBackground(new java.awt.Color(51, 204, 255));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addComponent(lbldisplay, javax.swing.GroupLayout.PREFERRED_SIZE, 190, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap())
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(jLabel7)
                        .addGap(18, 18, 18)
                        .addComponent(lbldisplay, javax.swing.GroupLayout.PREFERRED_SIZE, 147, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jButton1)
                    .addComponent(jButton2))
...
Connection c = DriverManager.getConnection("jdbc:mysql://localhost:3306/toll","root","");
Statement s = c.createStatement();
String sql="select qrcode from profile where username='"+username.getText()+"'";
ResultSet rs=s.executeQuery(sql);  
while(rs.next())
{  //lbldisplay.setIcon(ResizeImage(null, rs.getBytes("qrcode")));
  byte[] imagedata=rs.getBytes("qrcode");
               format=new ImageIcon(imagedata);
               lbldisplay.setIcon(format);
              /* Image mm=format.getImage();
               Image img2=mm.getScaledInstance(lbldisplay.getWidth(),lbldisplay.getHeight(), Image.SCALE_SMOOTH);
               ImageIcon image=new ImageIcon(mm);
   ...
   // ImageIcon image = new ImageIcon(new ImageIcon(rs.getBytes("qrcode")).getImage()
    //         .getScaledInstance(150, 120, Image.SCALE_SMOOTH) );    
   //ImageIcon icon = new ImageIcon(rs.getMyImage("qrcode"));
        JLabel label = new JLabel(format);
        qrcode.jLabel1.setIcon(format);
        frame.add(label);
...
{
JOptionPane.showMessageDialog(null,"ERROR : Cannot get data from database");
